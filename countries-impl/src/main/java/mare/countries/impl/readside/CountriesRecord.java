...
public class CountriesRecord {
    ...
    public CountriesRecord(Integer id) {
        this.id = id;
    }

    public CountriesRecord(Integer id, String countryCode, String countryName) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CountriesRecord)) {
            return false;
        }
        CountriesRecord other = (CountriesRecord) object;
